...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://23nl4cqj97.execute-api.eu-west-1.amazonaws.com/prod';
    ...
    apigClient.listPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        ...
        return apiGatewayClient.makeRequest(listPutRequest, authType, additionalParams, config.apiKey);
    };
